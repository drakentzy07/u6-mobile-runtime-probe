...
namespace Highfly.SkillLab
{
    ...
    public sealed class HighflyCharacterCompareV022 : MonoBehaviour
    {
        ...
        private void BuildUi(Transform parent)
        {
            ...
            br.anchorMin = br.anchorMax = new Vector2(0.70f, 1f);
            br.pivot = new Vector2(0.5f, 1f);
            br.anchoredPosition = new Vector2(0f, -20f);
            br.sizeDelta = new Vector2(650f, 154f);
            ...
            lr.anchoredPosition = new Vector2(18f, -18f);
            lr.sizeDelta = new Vector2(196f, 52f);
            ...
            kr.anchoredPosition = new Vector2(226f, -18f);
            kr.sizeDelta = new Vector2(196f, 52f);
            ...
            sr.anchoredPosition = new Vector2(18f, -78f);
            sr.sizeDelta = new Vector2(610f, 62f);
        }
