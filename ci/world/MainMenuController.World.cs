...
public class MainMenuController : MonoBehaviour
{
    ...
    {
        // WORLD LAB: provisional fast path. Skip the Lucid prologue so each
        // world iteration reaches Somnia immediately.
        if (GameManager.Instance != null)
            StartCoroutine(FadeAndLoad(() => GameManager.Instance.StartNewGame()));
        else
    ...
    private IEnumerator NewGameWithIntro_UNUSED_WORLD_LAB()
    {
